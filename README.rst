...
==To add sounds:
 # Add the sound files in the sound folder
 # Rename the file to `command.ext` where command is the name of the command you want the viewers to see and ext is the extensio of the file
 # Reload the script in Chatbot
